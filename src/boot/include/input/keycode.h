#ifndef ROOT_KEYCODE_H
#define ROOT_KEYCODE_H 1
...
static const char root_key_code_to_ascii_map[256]
...
static const char root_key_code_to_ascii_map_alt[256]
...
static inline int
root_is_key_code_alpha (root_keycode_t keycode)
{
  switch (keycode)
    {
    case ROOT_KEY_A:
